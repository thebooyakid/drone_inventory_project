...
from drone_inventory.helpers import token_required, JSONEncoder
from models import db,User,Drone,drone_schema,drones_schema
#drone_inventory.models
...
def create_drone(current_user_token):
    ...
    drone = Drone(name,description,price,cam_quality,flight_time,max_speed,dimensions,weight,cost_of_production,series,user_token = user_token)
